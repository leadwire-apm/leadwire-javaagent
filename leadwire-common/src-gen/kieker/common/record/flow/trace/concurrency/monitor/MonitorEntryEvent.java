...
public class MonitorEntryEvent extends AbstractMonitorEvent  {
	 ...
	 *
	 * @deprecated since 1.13. Use {@link #MonitorEntryEvent(IValueDeserializer)} instead.
	 */
	@Deprecated
	public MonitorEntryEvent(final Object[] values) { // NOPMD (direct store of values)
		super(values, TYPES);
	}
	 ...
	 */
	@Deprecated
	protected MonitorEntryEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values stored directly)
	 ...
	 */
	public MonitorEntryEvent(final IValueDeserializer deserializer) {
		super(deserializer);
	}
