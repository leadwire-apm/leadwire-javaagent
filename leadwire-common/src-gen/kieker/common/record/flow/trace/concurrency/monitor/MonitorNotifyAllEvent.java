...
public class MonitorNotifyAllEvent extends AbstractMonitorEvent  {
	 ...
	 *
	 * @deprecated since 1.13. Use {@link #MonitorNotifyAllEvent(IValueDeserializer)} instead.
	 */
	@Deprecated
	public MonitorNotifyAllEvent(final Object[] values) { // NOPMD (direct store of values)
		super(values, TYPES);
	}
	 ...
	 */
	@Deprecated
	protected MonitorNotifyAllEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values stored directly)
	 ...
	 */
	public MonitorNotifyAllEvent(final IValueDeserializer deserializer) {
		super(deserializer);
	}
