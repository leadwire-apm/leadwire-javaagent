...
@Aspect
public abstract class AbstractServletAspect2 extends AbstractOperationExecutionAspect {
	...
	public Object servletservice(final ProceedingJoinPoint thisJoinPoint) throws Throwable { // NOCS (Throwable)
		...
		if (completeURL.endsWith(".css") || completeURL.endsWith(".js") || completeURL.endsWith(".gif") || completeURL.endsWith(".png")) {
			...
			if (CTRLINST.isRumEnable()){
				...
				if (aContentType != null
					...
					if ( isBeaconed == null ) {		
						...
						String rum= "\n"
						+ "<script type=\"text/javascript\" src=\"http://"+rumServer+"/boomerang-master/boomerang.js\"></script> "
						+ "<script type=\"text/javascript\" src=\"http://"+rumServer+"/boomerang-master/plugins/navtiming.js\"></script> "
						+ "<script type=\"text/javascript\" src=\"http://"+rumServer+"/boomerang-master/plugins/rt.js\"></script> "
