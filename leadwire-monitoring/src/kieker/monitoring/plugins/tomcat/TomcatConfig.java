...
import kieker.monitoring.bootstrap.config.ExcludeMethodFilter;
import kieker.monitoring.bootstrap.config.ExcludePathFilter;
import kieker.monitoring.bootstrap.config.Filter;
import kieker.monitoring.bootstrap.config.ProfilerConfig;
import kieker.monitoring.bootstrap.config.SkipFilter;
