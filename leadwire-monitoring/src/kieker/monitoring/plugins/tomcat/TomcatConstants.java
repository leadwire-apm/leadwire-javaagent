...
import static kieker.monitoring.common.trace.ServiceTypeProperty.*;

import kieker.monitoring.common.trace.ServiceType;
import kieker.monitoring.common.trace.ServiceTypeFactory;
...
public final class TomcatConstants {
    ...
    public static final String ASYNC_ACCESSOR = "kieker.monitoring.plugin.tomcat.AsyncAccessor";
    public static final String TRACE_ACCESSOR = "kieker.monitoring.plugin.tomcat.TraceAccessor";
