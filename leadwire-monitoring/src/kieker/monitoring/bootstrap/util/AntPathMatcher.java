...
public class AntPathMatcher implements PathMatcher {
    ...
    private final kieker.monitoring.bootstrap.util.spring.AntPathMatcher springAntMatcher;
    private final String pattern;

    public AntPathMatcher(String pattern) {
        this(pattern, kieker.monitoring.bootstrap.util.spring.AntPathMatcher.DEFAULT_PATH_SEPARATOR);
    }
    ...
    public AntPathMatcher(String pattern, String pathSeparator) {
        ...
        this.springAntMatcher = new kieker.monitoring.bootstrap.util.spring.AntPathMatcher(pathSeparator);
