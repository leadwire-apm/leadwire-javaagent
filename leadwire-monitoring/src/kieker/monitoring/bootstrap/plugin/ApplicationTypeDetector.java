 ...
 */
package kieker.monitoring.bootstrap.plugin;
...
public interface ApplicationTypeDetector {
     ...
     * with code in a range corresponding to {@link kieker.monitoring.common.trace.ServiceTypeCategory#SERVER}
     * 
     * @return the {@link ServiceType} representing the current plugin
     * @see ServiceType#isWas()
     * @see kieker.monitoring.common.trace.ServiceTypeCategory#SERVER
     */
